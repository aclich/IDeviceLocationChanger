...
def test_tunnel(udid: str = None):
    ...
    print("\n[3] Starting tunnel...")
    result = tm.start_tunnel(device.id)
    ...
    # Step 4: Test RSD connection (pymobiledevice3 RSD is async)
    ...
    result = ls.set_location(device, test_lat, test_lon)
    ...
    print("\n[6] Clearing location...")
    result = ls.clear_location(device)
    if result.get("success"):
